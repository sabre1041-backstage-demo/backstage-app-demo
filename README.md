...
```shell
docker build . -t quay.io/sabre1041-backstage-demo/backstage:latest --no-cache
docker login quay.io/sabre1041-backstage-demo/backstage
docker push quay.io/sabre1041-backstage-demo/backstage:latest
```

note the images is already pushed to `ghcr.io/sabre1041-backstage-demo/backstage-app-demo:main`
